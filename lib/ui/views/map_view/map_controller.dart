...
import 'package:food_1/core/Data/models/apis/country_model.dart';
import 'package:food_1/core/services/base_controller.dart';
import 'package:food_1/core/utils/map_util.dart';
...
class MapController extends BaseController {
  ...
  List<Map<String, dynamic>> countryJsonList = [
    {
      "country": "Albania",
      "alpha2": "AL",
      "alpha3": "ALB",
  ...
  List<Country> resultList = <Country>[].obs;
    ...
    countryJsonList.forEach(
      (element) {
        try {
          ...
          print('Error in parsing JSON: ${e.toString()}');
        }
      },
    );
    super.onInit();
